use cosmwasm_std::{
    Addr, BankMsg, Binary, coins, Deps, DepsMut, Env, from_slice, MessageInfo, Order, Response,
...
mod tests {
    use cosmwasm_std::{
        coin, CosmosMsg, from_slice, OverflowError, OverflowOperation, StdError, Storage,
    };
