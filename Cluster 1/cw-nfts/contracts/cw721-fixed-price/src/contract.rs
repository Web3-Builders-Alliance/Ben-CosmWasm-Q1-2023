...
use cw721_base::{
    Extension, helpers::Cw721Contract,
    MintMsg, msg::ExecuteMsg as Cw721ExecuteMsg, msg::InstantiateMsg as Cw721InstantiateMsg,
};
...
#[cfg(test)]
mod tests {
    use cosmwasm_std::{CosmosMsg, from_binary, SubMsgResponse, SubMsgResult, to_binary};
