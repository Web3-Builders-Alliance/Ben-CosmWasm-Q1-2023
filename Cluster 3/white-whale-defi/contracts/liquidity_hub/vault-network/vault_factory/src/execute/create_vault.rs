use cosmwasm_std::{DepsMut, Env, ReplyOn, Response, SubMsg, to_binary, WasmMsg};
...
mod tests {
    use cosmwasm_std::{
        Addr, Decimal, ReplyOn, Response, StdError, SubMsg, testing::mock_info, to_binary, WasmMsg,
    };
