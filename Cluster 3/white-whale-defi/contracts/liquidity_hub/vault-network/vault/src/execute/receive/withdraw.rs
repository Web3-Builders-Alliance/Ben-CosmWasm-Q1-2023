use cosmwasm_std::{
    BankMsg, coins, CosmosMsg, Decimal, DepsMut, Env, Response, to_binary, Uint128, WasmMsg,
};
...
mod tests {
    use cosmwasm_std::{
        Addr,
        BankMsg,
        coins, Response, SubMsg, testing::{mock_env, mock_info}, to_binary, Uint128, WasmMsg,
    };
