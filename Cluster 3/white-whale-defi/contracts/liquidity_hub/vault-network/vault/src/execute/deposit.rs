use cosmwasm_std::{CosmosMsg, DepsMut, Env, MessageInfo, Response, to_binary, Uint128, WasmMsg};
...
mod test {
    use cosmwasm_std::{
        Addr,
        BankMsg,
        coins, CosmosMsg, Response, testing::{mock_dependencies, mock_env, mock_info}, to_binary, Uint128, WasmMsg,
    };
