use cosmwasm_std::{
    Coin, ContractResult,
    Empty,
    from_binary, from_slice, OwnedDeps, Querier, QuerierResult, QueryRequest, SystemError, SystemResult,
    testing::{MockApi, MockQuerier, MockStorage}, to_binary, Uint128, WasmQuery,
};
