use cosmwasm_std::{Addr, BankMsg, Coin, Response, to_binary};
...
pub fn create_dummy_flash_loan_contract() -> ContractWrapper<ExecuteMsg, InstantiateMsg, QueryMsg, VaultError, VaultError, VaultError> {
    ContractWrapper::new(
